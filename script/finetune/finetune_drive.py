...
from retinal_fundus_encoder.dataset import DRIVEDataset
...
def main():
    ...
    if args.train_image_dir and args.train_mask_dir:
        train_dataset = DRIVEDataset(args.train_image_dir, args.train_mask_dir)
    eval_dataset = None
    if args.eval_image_dir and args.eval_mask_dir:
        eval_dataset = DRIVEDataset(args.eval_image_dir, args.eval_mask_dir)
