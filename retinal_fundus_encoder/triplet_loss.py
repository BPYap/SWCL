# Adapted from https://github.com/alfonmedela/triplet-loss-pytorch/blob/master/loss_functions/triplet_loss.py
...
def TripletSemiHardLoss(y_true, y_pred, margin):
...
class TripletLoss(nn.Module):
    ...
    def forward(self, input, target, **kwargs):
        return TripletSemiHardLoss(target, input, self.margin)
